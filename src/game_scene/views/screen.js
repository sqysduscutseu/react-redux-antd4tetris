...
const Screen = (props) => {
    ...
    return( <div className = 'screen-wrap'>
                     <div className = 'screen' >
                         {blocks.map((block, index) => <Shape key = {index} shape = {block.shape} 
                         color = {block.color} left = {block.left} bottom = {block.bottom} />)
                         }
                     </div>
            </div>)
}
...
//         // currentBlockNo = Math.floor(Math.random() * 7);
//         // let colorNo = Math.floor(Math.random() * 7);
//         // let firstBlock = {shape: this.blockShape[currentBlockNo].shapes[0], color: this.randomColor[colorNo], left: 9, bottom: 31}
//         blocks[0] = firstBlock;
...
//                 console.log(i);
//                 console.log(shape[i].x + left + 1, shape[i].y + bottom);
//                 if(blockShape[currentBlockNo].shapes[phase][i].x + left === 0
//                     || blockShape[currentBlockNo].shapes[phase][i].x + left === 19
//                     || blockShape[currentBlockNo].shapes[phase][i].x + bottom === 0
//                     || blockMatrix[blockShape[currentBlockNo].shapes[phase][i].x + left][blockShape[currentBlockNo].shapes[phase][i].y + bottom]){
//                         console.log('inner',shape[i].x + left + 1, shape[i].y + bottom);
//                         if(phase === 0){
//                             phase = 3;
//                         }
//                         else{
...
//             // 加速功能待实现
//             // for(let i in shape){
//             //     if(shape[i].y + bottom === 1 || blockMatrix[shape[i].x + left][shape[i].y + bottom - 1]){
//             //         this.blockFalling();
//             //         return;
//             //     }
//             //     else{
...
//                 <div className = 'screen' onClick = {this.gameStart}>
